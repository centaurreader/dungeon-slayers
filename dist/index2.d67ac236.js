...
var _uicontrollerJsDefault = parcelHelpers.interopDefault(_uicontrollerJs);
class Game {
    state = null;
    ui = null;
    constructor(uiElements){
        this.state = new _gameStateJsDefault.default();
        this.ui = new _uicontrollerJsDefault.default(uiElements);
        uiElements.forEach((element)=>element.setUpdateCallback((state)=>this.updateState(state)
            )
        );
    }
    updateState(state) {
...
},{"./GameState.js":"btEjD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./UIController.js":"6kdiv"}],"btEjD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class GameState {
    state = {
...
},{}],"6kdiv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class UIController {
    scenes = [];
...
var _uielementJsDefault = parcelHelpers.interopDefault(_uielementJs);
class StartGameButton extends _uielementJsDefault.default {
    constructor(element){
        super(element);
